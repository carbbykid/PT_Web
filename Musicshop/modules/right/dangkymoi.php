...
<div class="dangky">
  ...
  <tr>
    <td width="40%">Họ tên người mua <strong style="color:blue;"> (*)</strong></td>
    <td width="60%"><input type="text" name="hoten" size="50"></td>
  </tr>
  <tr>
    <td>Địa chỉ Email <strong style="color:blue;"> (*)</strong></td>
  ...
  <tr>
    <td>Điện thoại <strong style="color:blue;"> (*)</strong></td>
     <td width="60%"><input type="text" name="dienthoai" size="50"></td>
  </tr>
  <tr>
    <td>Địa chỉ nhận hàng <strong style="color:blue;"> (*)</strong></td>
